...
public class Encrypt {
	...
	//高强度加密算法,不可逆
	public static String md5(String password, String salt,Integer number){
		return new Md5Hash(password,salt,number).toString();
	}

	public static void main(String[] args) {
		System.out.println(new Md5Hash("123456","adminSHY",3).toString());
	}
}
